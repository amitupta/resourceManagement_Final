...
import com.rms.Repositories.ProjectRepository;
...
public class UserServiceImpl implements UserService {
	...
	public User saveUser(User user) {
		...
		List<User> fetchuser = userRepository.findByEmpIdAndFirstNameAndLastName(user.getEmpId(), user.getFirstName(),
				user.getLastName());
	...
	public User getByEmpId(String empId) {
		...
		User user = null;
		try {
			user = userRepository.getByEmpId(empId);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<User> getAllEmp() {
		...
		try {
			userLst = userRepository.findAll();
	...
	public User editUser(User user) {
		...
		String id = user.getEmpId();
		 User fetchuser = null;
		try {
		 fetchuser = userRepository.getByEmpId(id);
		} catch (Exception e) {
		     e.printStackTrace();
		}
